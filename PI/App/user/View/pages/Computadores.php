...
<?php if (!empty($produtos)): ?>
    <?php foreach ($produtos as $produto): ?>
        <div class="c-produtos-card">
            <img class="c-heart" src="../../../../public/assets/img/heart_disabled.png" alt="coração" onclick="AtivarCoracao(this)">
            <a href="../PI/App/user/View/pages/Carrinho.php"><img class="c-add-carrinho" src="../../../../public/assets/img/carrinho-card.png" alt=""></a>
