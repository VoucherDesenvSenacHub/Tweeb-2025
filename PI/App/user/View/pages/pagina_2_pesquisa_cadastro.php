...
<body class="pesquisa2-cadastro-body">
  ...
  <div class="pesquisa2-cadastro-cards-container">
    <div class="pesquisa2-cadastro-card1 card-opcao">
      ...
      <h1 class="pesquisa2-cadastro-h1-card1">Eu me interesso por games, computadores e hardwares.</h1>
    ...
    <div class="pesquisa2-cadastro-card2 card-opcao">
      ...
      <h1 class="pesquisa2-cadastro-h1-card2">Eu me interesso por tecnologia para o dia a dia.</h1>
  ...
  <script>
    document.querySelectorAll('.card-opcao').forEach((card, index) => {
      card.addEventListener('click', () => {
        let resposta = index === 0 ? 'games e hardware' : 'tecnologia cotidiana';
        localStorage.setItem('resposta2', resposta);
