...
<body class="pesquisa2-cadastro-body">
    <header class="pesquisa2-cadastro-header">
        <img src="../../../../public/assets/img/logo_img.png" alt="image-1" class="pesquisa2-cadastro-logo-tweeb">
    ...
    <div class="pesquisa2-cadastro-continuar-button-container">
        <div class="pesquisa2-cadastro-continuar-button">
            <a href="../pages/pagina_3_pesquisa_cadastro.php" class="pesquisa2-cadastro-link-continuar">
                Continuar
            </a>
        </div>
    </div>
